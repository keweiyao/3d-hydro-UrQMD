...
//>>MODIFICATION!-------added by Weiyao-----------
    ("switch-3d", po::bool_switch()->default_value(false),
     "switch of 3d IC")
    ("out-3d", po::bool_switch()->default_value(false),
     "switch of 3d output");
//<<MODIFICATION!-------added by Weiyao-----------
  ...
  phys_opts.add_options()
    ...
    ("rapidity-width",
     po::value<double>()->value_name("FLOAT")->default_value(3.0, "3.0"),
     "rapidity width")
    ("<pt2/mt2>",
    ...
    ("rapidity-skew,w",
     ...
     "rapidity skewness coefficient [fm^-2]")
    ("rapidity-kurtosis,w",
     po::value<double>()->value_name("FLOAT")->default_value(1.0, "1.0"),
     "rapidity kurtosis [1]")
    ("cross-section,x",
...
//>>MODIFICATION!-------added by Weiyao-----------
    ("eta-max",
     po::value<double>()->default_value(10., "10.0"),
     "half width of pseudorapidty range")
    ("eta-step",
     po::value<int>()->default_value(32, "32"),
     "half width of pseudorapidty range");
